(function(){
    ...
    //Buscar en el documento todos los elementos INPUT 
    //de tipo texto, ya que solamente en ellos se va 
    //a registrar un controlador de evento.
    function init(){
        var inputtag = document.getElementById("factorial");
    ...
    function filter(event) {
        ...
        //Si se ha pulsado una tecla de función de cualquier 
        //tipo, no filtrarla
